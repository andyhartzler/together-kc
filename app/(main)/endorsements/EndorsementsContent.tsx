...
export default function EndorsementsContent() {
  ...
  return (
    <>
      ...
      <section className="relative pt-44 sm:pt-52 pb-72 sm:pb-96 md:pb-72 lg:pb-96 bg-gradient-to-br from-navy via-navy/95 to-sky/80 overflow-x-hidden">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-5">
            {ENDORSERS.organizations.map((org, index) => (
              <EndorserCard
                ...
                logoOffsetY={'logoOffsetY' in org ? (org as { logoOffsetY?: number }).logoOffsetY : undefined}
                index={index}
              />
            ))}
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 max-w-4xl mx-auto">
            {ENDORSERS.electedOfficials.map((official, index) => {
              const getObjectPosition = () => {
                ...
                if (official.name === 'Patty Lewis') return 'object-top';
