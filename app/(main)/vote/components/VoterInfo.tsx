...
export default function VoterInfo({ county }: Props) {
    ...
    return (
      <div className="max-w-6xl mx-auto px-4 pt-10 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {/* What to Bring */}
          <div className="rounded-2xl bg-white/[0.04] border border-golden/20 p-6 relative overflow-hidden">
          ...
          <div className="rounded-2xl bg-white/[0.04] border border-white/[0.1] p-6 relative overflow-hidden">
          ...
          {/* Check Registration */}
          <div className="rounded-2xl bg-white/[0.04] border border-sky/20 p-6 flex flex-col relative overflow-hidden">
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 pt-10 pb-24">
      ...
      <p className="text-white/30 text-[10px] uppercase tracking-[0.2em] font-semibold mb-5">Your Election Board</p>
