...
export const AUGUST_BALLOT = {
  ...
  costs: {
    ...
    points: [
      ...
      'Central City is a renewal of an existing tax, not a new one. The one-eighth-cent sales tax has been collected citywide since 2017 to fund East Side development. A YES vote keeps that rate exactly where it is. Shoppers see no increase. If it fails, the tax simply expires after September 30, 2027.',
    ],
    bottomLine:
  ...
  measures: [
    ...
    },
    {
      ...
      mechanism:
        'Renewal of an existing 1/8-percent (one-eighth-cent) local sales tax authorized under Section 67.1305 of the Revised Statutes of Missouri. It is collected citywide on taxable retail purchases in Kansas City, Missouri, and pooled into a dedicated economic-development fund spent inside the Central City district. It is not a bond and not a property tax. A Central City Economic Development (CCED) Sales Tax Board reviews developer applications and recommends projects to the City Council; as of September 2025 the program is administered by the Economic Development Corporation of Kansas City (EDCKC). The ballot language also allows proceeds to retire debt on previously authorized bonds or to repay bonds not yet issued.',
      honestCost:
      ...
      faqs: [
        { q: 'Is this a new tax or a tax increase?', a: 'Neither. Question 3 renews the one-eighth-cent (1/8%) sales tax that Kansas City has already collected citywide since 2017. The rate does not change, so shoppers see no increase. It is a renewal, not a new tax.' },
        ...
        { q: 'Where does the tax apply, and who pays it?', a: 'It is collected citywide: anyone making a taxable retail purchase inside the Kansas City, Missouri city limits pays the one-eighth-cent rate. The district defines where the money is spent. Every dollar is dedicated to economic-development projects within the Central City district on the East Side, bounded by 9th Street on the north, Gregory Boulevard on the south, The Paseo on the west, and Indiana Avenue on the east.' },
