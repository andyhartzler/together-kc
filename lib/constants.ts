...
export const ENDORSERS = {
  ...
  cityOfficials: [
    ...
    { name: 'Lindsay French', title: 'Councilmember', district: '1st District', photo: '/images/council/Lindsay-French.png' },
  ...
  electedOfficials: [
    ...
    { name: 'Bill Allen', title: 'State Representative', district: 'House District 17', photo: '/images/council/Bill_Allen.jpg' },
  ],
} as const;
